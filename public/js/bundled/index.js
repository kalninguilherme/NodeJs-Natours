(() => {
  ...
  var R = TypeError;
  (G = function (t) {
    if (z(t)) throw R("Can't call method on " + t);
    return t;
  }),
    (P = function (t) {
      return M(G(t));
  ...
  var H = {},
    ...
    V = (Z = { all: J, IS_HTMLDDA: void 0 === J && void 0 !== J }).all;
  W = Z.IS_HTMLDDA
    ? function (t) {
  ...
  $ = Z.IS_HTMLDDA
    ? function (t) {
        return 'object' == typeof t ? null !== t : W(t) || t === K;
      }
    : function (t) {
  ...
  tv = function (t, e) {
    var r, n;
    if (
      ('string' === e && W((r = t.toString)) && !$((n = L(r, t)))) ||
      (W((r = t.valueOf)) && !$((n = L(r, t)))) ||
      ('string' !== e && W((r = t.toString)) && !$((n = L(r, t))))
    )
      return n;
  ...
  var tx = {},
    ...
    tM = _((1).toString);
  tx = function (t) {
    return 'Symbol(' + (void 0 === t ? '' : t) + ')_' + tM(++tI + tP, 36);
  };
  var t_ = b.Symbol,
    tk = tm('wks'),
    tF = tt ? t_.for || t_ : (t_ && t_.withoutSetter) || tx,
    tN = TypeError,
    tC = (function (t) {
      return tL(tk, t) || (tk[t] = te && tL(t_, t) ? t_[t] : tF('Symbol.' + t)), tk[t];
    })('toPrimitive');
  (Y = function (t, e) {
    if (!$(t) || U(t)) return t;
    var r,
      n = tl(t, tC);
    if (n) {
      if ((void 0 === e && (e = 'default'), !$((r = L(n, t, e))) || U(r))) return r;
  ...
  var tD = {},
    tB = {},
    tA = b.document,
    tq = $(tA) && $(tA.createElement);
  (tB = function (t) {
    return tq ? tA.createElement(t) : {};
  }),
    (tD =
      !E &&
      !S(function () {
        return (
          7 !=
          Object.defineProperty(tB('div'), 'a', {
            get: function () {
              return 7;
            },
          }).a
  ...
  (o = E
    ? tR
      ? function (t, e, r) {
          if (
            (tH(t), (e = H(e)), tH(r), 'function' == typeof t && 'prototype' === e && 'value' in r && tU in r && !r[tU])
          ) {
            var n = tJ(t, e);
            n &&
              n[tU] &&
              ((t[e] = r.value),
              (r = { configurable: tK in r ? r[tK] : n[tK], enumerable: tV in r ? r[tV] : n[tV], writable: !1 }));
          }
          return tZ(t, e, r);
        }
      : tZ
    : function (t, e, r) {
        if ((tH(t), (e = H(e)), tH(r), tD))
          try {
            return tZ(t, e, r);
          } catch (t) {}
  ...
  var ea = (t4 = {
      ...
      getterFor: function (t) {
        return function (e) {
          var r;
          if (!$(e) || (r = a(e)).type !== t) throw er('Incompatible receiver, ' + t + ' required');
          return r;
        };
      },
    }).enforce,
  ...
  var eP = function (t) {
    ...
    eM = { includes: eP(!0), indexOf: eP(!1) }.indexOf,
    e_ = _([].push);
  eg = function (t, e) {
    var r,
      n = P(t),
      o = 0,
      i = [];
    for (r in n) !tL(et, r) && tL(n, r) && e_(i, r);
    for (; e.length > o; ) tL(n, (r = e[o++])) && (~eM(i, r) || e_(i, r));
    return i;
  };
  var ek = [
    'constructor',
  ...
  var eN = {},
    ...
    eD = function (t, e) {
      var r = eA[eB(t)];
      return r == eG || (r != eq && (W(e) ? S(e) : !!e));
    },
    eB = (eD.normalize = function (t) {
      return String(t).replace(eC, '.').toLowerCase();
    }),
    eA = (eD.data = {}),
    eq = (eD.NATIVE = 'N'),
    eG = (eD.POLYFILL = 'P');
      ...
      if ((n = s ? b : l ? b[c] || tw(c, {}) : (b[c] || {}).prototype))
        for (o in r) {
          if (
            ...
            !eN(s ? o : c + (l ? '.' : '#') + o, e.forced) && void 0 !== i)
          ) {
            if (typeof a == typeof i) continue;
            ey(a, i);
          }
          (e.sham || (i && i.sham)) && tz(a, 'sham', !0), tX(n, o, a, e);
        }
    });
  var ez = {},
    eR = {},
  ...
  eR =
    ...
    (T
      ? e$.bind(eY)
      : function () {
          return e$.apply(eY, arguments);
        });
  var eW = {},
    eZ = {},
    eJ = (eZ = function (t) {
      if ('Function' === C(t)) return _(t);
    })(eZ.bind);
  eW = function (t, e) {
    return (
      tf(t),
  ...
  (rn && ro) ||
    ...
    e0
      ...
      : (h =
          rp in tB('script')
            ? function (t) {
                eV.appendChild(tB('script'))[rp] = function () {
                  eV.removeChild(this), rd(t);
                };
              }
            : function (t) {
                setTimeout(rh(t), 0);
              }));
  var rm = (ez = { set: rn, clear: ro }).clear;
  ...
  let rj = () => {
    ...
    rI = async () => {
      try {
        let t = await axios({ method: 'GET', url: 'http://127.0.0.1:8000/api/v1/users/logout' });
    ...
    rP = async (t, e) => {
      try {
        ...
        'success' === r.data.status && rO('success', `${e.toUpperCase()} updated successfully!`);
      } catch (t) {
        rO('error', t.response.data.message);
      }
    },
    rM = document.getElementById('map'),
    r_ = document.querySelector('.form--login'),
    rk = document.querySelector('.nav__el--logout'),
    rF = document.querySelector('.form-user-data'),
    rN = document.querySelector('.form-user-password');
  if (rM) {
    let t = JSON.parse(rM.dataset.locations);
    ((t) => {
  ...
  r_ &&
    r_.addEventListener('submit', (t) => {
      t.preventDefault();
      let e = document.getElementById('email').value,
        r = document.getElementById('password').value;
      rx(e, r);
    }),
    rk && rk.addEventListener('click', rI),
    rF &&
      rF.addEventListener('submit', (t) => {
        t.preventDefault();
        let e = document.getElementById('name').value,
          r = document.getElementById('email').value;
        rP({ name: e, email: r }, 'data');
      }),
    rN &&
      rN.addEventListener('submit', async (t) => {
